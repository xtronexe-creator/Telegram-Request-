...
TIMEZONE = "Asia/Dhaka"
USERS_FILE = "user.json"             # FIXED (আপনার ফাইল অনুযায়ী)
# ------------------------------------------
...
async def join_request(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        print(f"Approve failed {user.id}: {e}")
